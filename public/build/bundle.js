...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    const httpLink = new HttpLink({
      uri: 'http://142.93.156.195/v1/graphql'
    });

    // Create a WebSocket link:
    const wsLink = new WebSocketLink({
      uri: `ws://142.93.156.195/v1/graphql`,
      options: {
        reconnect: true
      }
    });
    ...
    /* src/Components/_TodoRow.svelte generated by Svelte v3.21.0 */
    const file = "src/Components/_TodoRow.svelte";

    // (86:2) {:else}
    function create_else_block(ctx) {
    	let div;
    	let t_value = /*todo*/ ctx[0].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			add_location(div, file, 86, 4, 1767);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*todo*/ 1 && t_value !== (t_value = /*todo*/ ctx[0].name + "")) set_data_dev(t, t_value);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "Todo name");
    			input.autofocus = true;
    			add_location(input, file, 83, 6, 1618);
    			add_location(form, file, 81, 4, 1525);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, form, anchor);
    			append_dev(form, input);
    			set_input_value(input, /*todo*/ ctx[0].name);
    			input.focus();
    			if (remount) run_all(dispose);

    			dispose = [
    				listen_dev(input, "input", /*input_input_handler*/ ctx[5]),
    				action_destroyer(clickOutside_action = clickOutside.call(null, input)),
    				listen_dev(input, "clickOutside", /*editTodo*/ ctx[3], false, false, false),
    				listen_dev(form, "submit", prevent_default(/*editTodo*/ ctx[3]), false, true, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*todo*/ 1 && input.value !== /*todo*/ ctx[0].name) {
    				set_input_value(input, /*todo*/ ctx[0].name);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let input;
    	let t1;
    	let t2_value = (/*todo*/ ctx[0].completed ? "done" : "pending") + "";
    	let t2;
    	let t3;
    	let td2;
    	let button;
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*edit*/ ctx[1]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file, 79, 0, 1471);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 91, 4, 1823);
    			add_location(label, file, 90, 2, 1811);
    			add_location(td1, file, 89, 0, 1804);
    			set_style(button, "padding", ".1rem .4rem");
    			add_location(button, file, 99, 2, 2004);
    			add_location(td2, file, 98, 0, 1997);
    		},
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			input.checked = /*todo*/ ctx[0].completed;
    			append_dev(label, t1);
    			append_dev(label, t2);
    			...
    			dispose = [
    				listen_dev(td0, "click", /*click_handler*/ ctx[6], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*todo*/ 1 && t2_value !== (t2_value = (/*todo*/ ctx[0].completed ? "done" : "pending") + "")) set_data_dev(t2, t2_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    `;
    	...
    	client$1.mutate({ mutation, variables: { id: todo.id } });
    }
    ...
    `;
    		...
    		client$1.mutate({
    			mutation,
    			variables: { id: todo.id, name: todo.name }
    		});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<TodoRow> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("TodoRow", $$slots, []);
    	...
    	const click_handler = t => toggleEdit();
    	...
    	const change_handler = () => updateTodo(todo);
    	const click_handler_1 = () => deleteTodo(todo);
    ...
    class TodoRow extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get todo() {
    		throw new Error("<TodoRow>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set todo(value) {
    		throw new Error("<TodoRow>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/Components/_TodoAdd.svelte generated by Svelte v3.21.0 */
    const file$1 = "src/Components/_TodoAdd.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("Add Todo");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "New Todo Name");
    			add_location(input, file$1, 39, 2, 742);
    			button.disabled = button_disabled_value = /*NewTodo*/ ctx[0].name == "" ? "disabled" : "";
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 40, 2, 819);
    			add_location(form, file$1, 38, 0, 695);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, form, anchor);
    			append_dev(form, input);
    			set_input_value(input, /*NewTodo*/ ctx[0].name);
    			append_dev(form, t0);
    			...
    			dispose = [
    				...
    				listen_dev(form, "submit", prevent_default(/*insertTodo*/ ctx[1]), false, true, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*NewTodo*/ 1 && input.value !== /*NewTodo*/ ctx[0].name) {
    				set_input_value(input, /*NewTodo*/ ctx[0].name);
    			}

    			if (dirty & /*NewTodo*/ 1 && button_disabled_value !== (button_disabled_value = /*NewTodo*/ ctx[0].name == "" ? "disabled" : "")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      `;
    			...
    			client$1.mutate({
    				mutation,
    				variables: { name: NewTodo.name }
    			});

    			$$invalidate(0, NewTodo.name = "", NewTodo);
    		}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<TodoAdd> was created with unknown prop '${key}'`);
    	});
    	...
    	return [NewTodo, insertTodo, input_input_handler];
    }
    ...
    // (46:6) {#if $todos && $todos.data}
    function create_if_block$1(ctx) {
    	let each_blocks = [];
    	let each_1_lookup = new Map();
    	let each_1_anchor;
    	let current;
    	let each_value = /*$todos*/ ctx[0].data.todo;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$todos*/ 1) {
    				const each_value = /*$todos*/ ctx[0].data.todo;
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(46:6) {#if $todos && $todos.data}",
    		ctx
    	});
    ...
    // (47:8) {#each $todos.data.todo as todo, index (todo)}
    function create_each_block(key_1, ctx) {
    	let tr;
    	let t;
    	let current;

    	const todorow = new TodoRow({
    			props: { todo: /*todo*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		c: function create() {
    			tr = element("tr");
    			create_component(todorow.$$.fragment);
    			t = space();
    			set_style(tr, "height", "3.5rem");
    			add_location(tr, file$2, 47, 10, 990);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			mount_component(todorow, tr, null);
    			append_dev(tr, t);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const todorow_changes = {};
    			if (dirty & /*$todos*/ 1) todorow_changes.todo = /*todo*/ ctx[3];
    			todorow.$set(todorow_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(todorow.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(todorow.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(tr);
    			destroy_component(todorow);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:8) {#each $todos.data.todo as todo, index (todo)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let t8;
    	let current;
    	let if_block = /*$todos*/ ctx[0] && /*$todos*/ ctx[0].data && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$2, 37, 6, 656);
    			add_location(th1, file$2, 38, 6, 676);
    			add_location(th2, file$2, 39, 6, 698);
    			add_location(thead, file$2, 36, 4, 642);
    			set_style(hr0, "margin-bottom", ".75rem");
    			set_style(hr0, "padding-bottom", ".25rem");
    			set_style(hr0, "border", "none");
    			set_style(hr0, "border-top", "1px solid lightgray");
    			add_location(hr0, file$2, 43, 10, 772);
    			attr_dev(td0, "colspan", "3");
    			add_location(td0, file$2, 42, 6, 745);
    			set_style(hr1, "margin-top", ".75rem");
    			set_style(hr1, "padding-top", ".25rem");
    			set_style(hr1, "border", "none");
    			set_style(hr1, "border-top", "1px solid lightgray");
    			add_location(hr1, file$2, 54, 10, 1144);
    			attr_dev(td1, "colspan", "3");
    			add_location(td1, file$2, 53, 8, 1117);
    			add_location(tr, file$2, 52, 6, 1104);
    			add_location(tbody, file$2, 41, 4, 731);
    			set_style(table, "text-align", "left");
    			add_location(table, file$2, 35, 2, 604);
    			add_location(main, file$2, 34, 0, 595);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(td1, hr1);
    			append_dev(td1, t8);
    			mount_component(todoadd, td1, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*$todos*/ ctx[0] && /*$todos*/ ctx[0].data) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
  ...
  `;
    	...
    	const todos = client$1.subscribe({ query });
